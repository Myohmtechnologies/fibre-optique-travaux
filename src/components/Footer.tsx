      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/blog/pourquoi-confier-travaux-telecom-entreprise" className="text-gray-300 hover:text-white transition-colors">
                  Fibre Optique travaux 
                </Link>
              </li>
              <li>
                <Link href="/blog/comment-deboucher-reparer-fourreau-gaine" className="text-gray-300 hover:text-white transition-colors">
                  Gaine bouchée fibre optique 
                </Link>
              </li>
              <li>
                <Link href="/blog/quand-realiser-tranchee-fibre-optique" className="text-gray-300 hover:text-white transition-colors">
                  Tranchée fibre optique travaux
                </Link>
              </li>
              <li>
                <Link href="/blog/regard-introuvable-installation-fibre-optique" className="text-gray-300 hover:text-white transition-colors">
                  Regard introuvable fibre optique 
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-300">06 31 37 27 01</span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 text-gray-400 mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-300">fibreoptiquetravaux1@gmail.com</span>
              </li>
              <li className="flex items-start">
                <svg className="h-6 w-6 text-gray-400 mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
