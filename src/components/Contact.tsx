            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="tel:+33XXXXXXXXX" className="text-blue-600 hover:underline">0787179186</a>
                </div>
              </div>
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:contact@fibreoptiquetravaux.fr" className="text-blue-600 hover:underline">contact@fibreoptiquetravaux.fr</a>
                </div>
              </div>
              <div className="flex items-start">
